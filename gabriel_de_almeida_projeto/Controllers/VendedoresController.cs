...
namespace gabriel_almeida.Controllers
{
    public class VendedoresController : Controller
    {
        ...
        {
            var myDbContext = _context.Vendedor.Include(v => v.NotaVenda);
        ...
        {
            ViewData["Notavendacod"] = new SelectList(_context.NotaDeVenda, "cod", "cod");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("idvende,nome,Notavendacod")] Vendedor vendedor)
        {
            ...
            ViewData["Notavendacod"] = new SelectList(_context.NotaDeVenda, "cod", "cod", vendedor.Notavendacod);
            return View(vendedor);
        }
        ...
        {
            return _context.Vendedor.Any(e => e.idvende == id);
        }
    }
}
