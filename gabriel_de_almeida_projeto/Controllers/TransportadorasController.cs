...
namespace gabriel_almeida.Controllers
{
    public class TransportadorasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,nome,codNotaDeVenda")] Transportadora transportadora)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,nome,codNotaDeVenda")] Transportadora transportadora)
        {
